package com.example.exerciseapp.pulltofresh.internal;
...
import com.example.exerciseapp.pulltofresh.PullToRefreshBase;
...
public class LoadingLayout extends FrameLayout {
    ...
    private final ImageView freshingImage;
    ...
    public LoadingLayout(Context context, final int mode, String releaseLabel, String pullLabel, String refreshingLabel) {
        ...
        freshingImage = (ImageView) header.findViewById(R.id.freshing_image);
...
//				headerImage.setImageResource(R.drawable.pulltorefresh_down_arrow);
    ...
    public void reset() {
        ...
        freshingImage.setVisibility(View.INVISIBLE);
    }
...
//		headerProgress.setVisibility(View.VISIBLE);
        freshingImage.setVisibility(View.VISIBLE);
    }
