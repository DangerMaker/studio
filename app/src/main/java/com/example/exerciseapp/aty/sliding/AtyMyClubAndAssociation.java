...
public class AtyMyClubAndAssociation extends BaseActivity {
	...
	private void setTitleBar() {
		...
		toolbar.setNavigationOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				AtyMyClubAndAssociation.this.finish();
			}
		});
	}
	...
	protected void onResume() {
		...
		StringRequest  stringRequestMyClub = new StringRequest(
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError volleyError) {
                    	spotsDialog.dismiss();
                    	Toast.makeText(AtyMyClubAndAssociation.this, Config.CONNECTION_ERROR, Toast.LENGTH_SHORT).show();
                    }
                }){
	 ...
	 @SuppressLint("ResourceAsColor") private void InitViewPager() {
