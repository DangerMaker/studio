...
public class ActivityOrganize extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_finder_organize);
...
//        t2.setOnClickListener(new MyOnClickListener(1));
    ...
    private void InitViewPager() {
        ...
        LayoutInflater mInflater = ActivityOrganize.this.getLayoutInflater();
        ...
        mPullToRefreshAssocListView.setOnRefreshListener(new PullToRefreshBase.OnRefreshListener<ListView>() {
            ...
            public void onRefresh(PullToRefreshBase<ListView> refreshView) {
                String label = DateUtils.formatDateTime(ActivityOrganize.this.getApplicationContext(), System.currentTimeMillis(),
        ...
        try {
            if (Config.getCachedAssocList(ActivityOrganize.this.getApplicationContext()) != null) {
                JSONArray jsonArr = Config.getCachedAssocList(ActivityOrganize.this.getApplicationContext());
        ...
        mAssocAdapter = new ClubAndAssocListAdapter(ActivityOrganize.this, mAssocListItems);
        ...
        assocListView.setOnItemClickListener(new OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view,
                ...
                Intent intent = new Intent(ActivityOrganize.this, AtyAssocOrClubInformation.class);
                        ...
                        public void onResponse(String s) {
                            try {
                                ...
                                if (jsonObject.getInt("result") == 1) {
                                    ...
                                    Config.cacheAssocList(ActivityOrganize.this.getApplicationContext(), jsonArr);
                                    jsonArr = Config.getCachedAssocList(ActivityOrganize.this.getApplicationContext());
                                ...
                                Toast.makeText(ActivityOrganize.this, Config.CONNECTION_ERROR, Toast.LENGTH_SHORT).show();
                                e.printStackTrace();
                            }
                        }
                    },
    ...
    private void InitImageView() {
        ...
        ActivityOrganize.this.getWindowManager().getDefaultDisplay().getMetrics(dm);
