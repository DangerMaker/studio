...
import com.example.exerciseapp.aty.team.TeamTagActivity;
 ...
 */
public class CreateZhuzhiFragment extends BaseFragment {
    ...
    protected int getLayoutRes() {
        return R.layout.fragment_create_zhuzhi;
    }
    ...
    public void goEdit(View view) {
        if (view.getId() == R.id.psubject) {
            ...
            Intent intent = new Intent();
            intent.setClass(getActivity(), AlterEditActivity.class);
