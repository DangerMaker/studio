...
public class MyEntryFormListAdapter extends BaseAdapter {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        TextView tvProjectnameMyEntryFormList = (TextView) itemView.findViewById(R.id.tvProjectnameMyEntryFormList);
...
//							intent.putExtra(Config.KEY_GAME_NAME, tvGameTitleMyEntryFormList.getText().toString());
            ...
            tvProjectnameMyEntryFormList.setText("项目名称：" + list.get(position).getString(Config.KEY_USER_ATTEND_ENAME));
