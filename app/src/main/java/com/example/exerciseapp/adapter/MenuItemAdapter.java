...
//	//菜单列表
//	private List<GameModel> mListData;
...
//
//	public MenuItemAdapter(Context context, List<GameModel> listData, int sId, int nId) {
//		mContext = context;
//		mListData = listData;
...
//	 */
//	public void setSelectedPositionNoNotify(int pos,ArrayList<GameModel> list) {
//		selectedPos = pos;
//		mListData = list;
//		if (mListData != null && pos < mListData.size()) {
//			selectedText = mListData.get(pos).getName();
