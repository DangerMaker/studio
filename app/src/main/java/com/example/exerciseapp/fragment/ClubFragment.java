...
//        //TODO
//        mPullToRefreshClubListView = (PullToRefreshListView) viewClub.findViewById(R.id.pull_to_refresh_listview);  
//        mPullToRefreshClubListView.setOnRefreshListener(new OnRefreshListener<ListView>() {  
//            @Override  
//            public void onRefresh(PullToRefreshBase<ListView> refreshView) {  
//                String label = DateUtils.formatDateTime(getActivity().getApplicationContext(), System.currentTimeMillis(),  
//                        DateUtils.FORMAT_SHOW_TIME | DateUtils.FORMAT_SHOW_DATE | DateUtils.FORMAT_ABBREV_ALL);  
...
//                  
//                // Do work to refresh the list here.  
//                new ClubGetDataTask().execute();  
//            }
//
//        });  
//          
//        ListView actualListView1 = mPullToRefreshClubListView.getRefreshableView();  
//          
//        mClubListItems = new LinkedList<JSONObject>();  
//        mClubListItems.addAll(mClubListItems);  
//          
//        mClubAdapter = new ClubAndAssocListAdapter(getActivity(), mClubListItems);  
//        actualListView1.setAdapter(mClubAdapter); 
//        
